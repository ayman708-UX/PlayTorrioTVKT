...
val releaseStoreFilePath = env("PLAYTORRIO_RELEASE_STORE_FILE")
    ?: localProperties.getProperty("PLAYTORRIO_RELEASE_STORE_FILE")
val releaseKeyAliasValue = env("PLAYTORRIO_RELEASE_KEY_ALIAS")
    ?: localProperties.getProperty("PLAYTORRIO_RELEASE_KEY_ALIAS", "playtorriotv")
val releaseKeyPasswordValue = env("PLAYTORRIO_RELEASE_KEY_PASSWORD")
    ?: localProperties.getProperty("PLAYTORRIO_RELEASE_KEY_PASSWORD", "815787")
val releaseStorePasswordValue = env("PLAYTORRIO_RELEASE_STORE_PASSWORD")
    ?: localProperties.getProperty("PLAYTORRIO_RELEASE_STORE_PASSWORD", "815787")
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "SUPPORTERS_API_BASE_URL", buildConfigString(localProperties.getProperty("SUPPORTERS_API_BASE_URL", "https://playtorrio.tv/")))
        buildConfigField("String", "SUPPORT_URL", buildConfigString(localProperties.getProperty("SUPPORT_URL", "https://playtorrio.tv/support")))
    ...
    productFlavors {
        ...
        create("playstore") {
            dimension = "distribution"
            applicationId = "com.playtorrio.app"
    ...
    val releaseKeystoreFile = releaseStoreFilePath?.let(::file) ?: file("../playtorriotv.jks")
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "SUPABASE_URL", buildConfigString(resolveProperty(devProperties, localProperties, "PLAYTORRIO_SUPABASE_URL")))
            buildConfigField("String", "SUPABASE_ANON_KEY", buildConfigString(resolveProperty(devProperties, localProperties, "PLAYTORRIO_SUPABASE_ANON_KEY")))
            buildConfigField("String", "SUPABASE_FALLBACK_URL", buildConfigString(resolveProperty(devProperties, localProperties, "PLAYTORRIO_SUPABASE_FALLBACK_URL")))
            buildConfigField("String", "TV_LOGIN_WEB_BASE_URL", "\"${devProperties.getProperty("TV_LOGIN_WEB_BASE_URL", "https://playtorrio.tv/tv-login")}\"")
            buildConfigField("String", "DEVICE_LOGIN_WEB_BASE_URL", "\"${devProperties.getProperty("DEVICE_LOGIN_WEB_BASE_URL", "https://playtorrio.tv/link")}\"")
            ...
            buildConfigField("String", "SUPPORTERS_API_BASE_URL", buildConfigString(resolveProperty(devProperties, localProperties, "SUPPORTERS_API_BASE_URL", "https://playtorrio.tv/")))
            buildConfigField("String", "SUPPORT_URL", buildConfigString(resolveProperty(devProperties, localProperties, "SUPPORT_URL", "https://playtorrio.tv/support")))
        ...
        release {
            ...
            buildConfigField("String", "SUPABASE_URL", buildConfigString(localProperties.getProperty("PLAYTORRIO_SUPABASE_URL", "")))
            buildConfigField("String", "SUPABASE_ANON_KEY", buildConfigString(localProperties.getProperty("PLAYTORRIO_SUPABASE_ANON_KEY", "")))
            buildConfigField("String", "SUPABASE_FALLBACK_URL", buildConfigString(localProperties.getProperty("PLAYTORRIO_SUPABASE_FALLBACK_URL", "")))
            buildConfigField("String", "TV_LOGIN_WEB_BASE_URL", "\"${localProperties.getProperty("TV_LOGIN_WEB_BASE_URL", "https://playtorrio.tv/tv-login")}\"")
            buildConfigField("String", "DEVICE_LOGIN_WEB_BASE_URL", "\"${localProperties.getProperty("DEVICE_LOGIN_WEB_BASE_URL", "https://playtorrio.tv/link")}\"")
            buildConfigField("String", "PARENTAL_GUIDE_API_URL", "\"${localProperties.getProperty("PARENTAL_GUIDE_API_URL", "")}\"")
            buildConfigField("String", "INTRODB_API_URL", "\"${localProperties.getProperty("INTRODB_API_URL", "")}\"")
...
androidComponents {
    onVariants(selector().withBuildType("debug")) { variant ->
        ...
        variant.applicationId.set(if (isPlaystore) "com.playtorrio.appdebug" else "com.playtorriodebug.com")
    }
}
...
// Globally exclude stock media3 modules — replaced by local :playtorrio-exoplayer-engine module
configurations.all {
...
dependencies {
    ...
    // com.playtorrio.tv.core.player.dvmkv. Media3 keeps these compileOnly in its own
    ...
    // PlayTorrio Engine local AARs (replaces lib-exoplayer, lib-common, lib-datasource, lib-datasource-okhttp, lib-exoplayer-hls, lib-extractor)
    ...
    add("fullImplementation", files("libs/quickjs-kt-android-1.0.5-playtorrio.aar"))
