...
-keep class com.playtorrio.tv.data.remote.api.** { *; }
...
-keep class com.playtorrio.tv.data.remote.dto.** { *; }
-keep class com.playtorrio.tv.domain.model.** { *; }
...
-keep class com.playtorrio.tv.core.server.** { *; }

# ── Torrent streaming (TorrServer) ─────────────────────────────────────────────
-keep class com.playtorrio.tv.core.torrent.** { *; }
...
-keep class com.playtorrio.tv.core.plugin.** { *; }
-keepclassmembers class com.playtorrio.tv.core.plugin.** { *; }
...
# Keep native interfaces and handles for PlayTorrio Engine JNI
...
-keep class io.ktor.** { *; }
-dontwarn io.ktor.**
-keep class com.playtorrio.tv.data.remote.supabase.** { *; }
