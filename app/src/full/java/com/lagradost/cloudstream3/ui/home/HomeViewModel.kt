 ...
 *
 * PlayTorrioTV's real home screen lives at [com.playtorrio.tv.ui.screens.home.HomeViewModel].
...
class HomeViewModel : ViewModel() {
    companion object {
         ...
         * PlayTorrioTV does not persist CS3 resume state, so this returns empty.
         */
        @JvmStatic
