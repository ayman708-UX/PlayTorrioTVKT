package com.playtorrio.tv.core.runtime
    ...
    fun ensureCloudstreamInitialized() {
        ...
        synchronized(this) {
            ...
            try {
                ...
                Log.w("PlayTorrioApplication", "Failed to install Conscrypt: ${e.message}")
            }
            ...
            try {
                ...
                Log.w("PlayTorrioApplication", "Failed to initialize NiceHttp client (API ${Build.VERSION.SDK_INT}): ${e.message}")
            }
