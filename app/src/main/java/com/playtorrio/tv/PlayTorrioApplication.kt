...
import com.playtorrio.tv.core.diagnostics.SentryInitializer
import com.playtorrio.tv.core.image.StaleWhileRevalidateCacheStrategy
import com.playtorrio.tv.core.runtime.PluginRuntimeHooks
import com.playtorrio.tv.core.sync.StartupSyncService
import com.playtorrio.tv.core.sync.androidtv.AndroidTvChannelSyncService
import com.playtorrio.tv.core.network.IPv4FirstDns
import com.playtorrio.tv.data.local.SentrySettingsDataStore
import com.playtorrio.tv.data.simkl.SimklAnimeIdPreferenceHolder
...
@HiltAndroidApp
class PlayTorrioApplication : Application(), SingletonImageLoader.Factory {
            ...
            OkHttpClient.Builder()
                ...
                .addInterceptor { chain ->
                    val request = chain.request().newBuilder()
                        .header("User-Agent", "PlayTorrio/1.3.6 (Android TV; +https://github.com/PlayTorrio)")
                        .build()
                    try {
