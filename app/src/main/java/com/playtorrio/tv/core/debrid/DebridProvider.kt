...
object DebridProviders {
    ...
    const val ALL_DEBRID_ID = "alldebrid"
    const val DEBRID_LINK_ID = "debridlink"
    ...
    private val registered = listOf(Torbox, Premiumize, RealDebrid, AllDebrid, DebridLink)
