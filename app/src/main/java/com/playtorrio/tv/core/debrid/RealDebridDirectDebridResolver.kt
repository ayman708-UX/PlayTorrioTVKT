...
import com.playtorrio.tv.data.remote.dto.RealDebridTorrentInfoDto
...
class RealDebridDirectDebridResolver @Inject constructor(
    ...
    suspend fun resolve(
        ...
        return try {
            ...
            var resolved = false
            try {
                var infoBefore: com.playtorrio.tv.data.remote.dto.RealDebridTorrentInfoDto? = null
                for (attempt in 0..10) {
    ...
    private fun retrofit2.Response<com.playtorrio.tv.data.remote.dto.RealDebridAddTorrentDto>.toFailureForAdd(): DirectDebridResolveResult {
        return when (code()) {
