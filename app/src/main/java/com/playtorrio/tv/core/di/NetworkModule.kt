...
import com.playtorrio.tv.data.remote.api.AniSkipApi
import com.playtorrio.tv.data.remote.api.AnimeSkipApi
import com.playtorrio.tv.data.remote.api.AuthDiagnosticReportApi
import com.playtorrio.tv.data.remote.api.GitHubReleaseApi
import com.playtorrio.tv.data.remote.api.SupportersApi
import com.playtorrio.tv.data.remote.api.TraktApi
import com.playtorrio.tv.data.remote.api.TrailerApi
import com.playtorrio.tv.data.remote.api.IntroDbApi
import com.playtorrio.tv.data.remote.api.ImdbTapframeApi
import com.playtorrio.tv.data.remote.api.MDBListApi
import com.playtorrio.tv.data.remote.api.ParentalGuideApi
import com.playtorrio.tv.data.remote.api.PlaybackIssueReportApi
import com.playtorrio.tv.data.remote.api.PremiumizeApi
import com.playtorrio.tv.data.remote.api.RealDebridApi
import com.playtorrio.tv.data.remote.api.SeriesGraphApi
import com.playtorrio.tv.data.remote.api.TmdbApi
import com.playtorrio.tv.data.remote.api.TorboxApi
import com.playtorrio.tv.data.remote.api.UniqueContributionsApi
import com.playtorrio.tv.data.simkl.OkHttpSimklEngine
import com.playtorrio.tv.data.simkl.SimklApiClient
import com.playtorrio.tv.data.simkl.SimklApiConfiguration
import com.playtorrio.tv.data.simkl.SimklAuthError
import com.playtorrio.tv.data.simkl.SimklAuthStorage
import com.playtorrio.tv.data.simkl.defaultSimklApiConfiguration
import com.playtorrio.tv.LocaleCache
...
import com.playtorrio.tv.core.network.IPv4FirstDns
import com.playtorrio.tv.core.diagnostics.SentryNetworkBreadcrumbInterceptor
import java.io.File
...
object NetworkModule {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                val request = chain.request().newBuilder()
                    .header("User-Agent", "PlayTorrio/$version")
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient, moshi: Moshi): Retrofit =
        Retrofit.Builder()
            .baseUrl("https://placeholder.playtorrio.tv/")
            .client(okHttpClient)
    ...
    fun provideSupportersRetrofit(okHttpClient: OkHttpClient, moshi: Moshi): Retrofit =
        Retrofit.Builder()
            .baseUrl(normalizedBaseUrl(BuildConfig.SUPPORTERS_API_BASE_URL, "https://playtorrio.tv/"))
            .client(okHttpClient)
            .addConverterFactory(MoshiConverterFactory.create(moshi))
            .build()
