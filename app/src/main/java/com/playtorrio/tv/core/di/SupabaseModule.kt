...
import com.playtorrio.tv.core.auth.TransientAuthRefreshException
import com.playtorrio.tv.core.auth.shouldRetryAuthRefreshResponse
import com.playtorrio.tv.core.network.BackendRateLimitCoordinator
import com.playtorrio.tv.core.network.BackendRateLimitPlugin
import com.playtorrio.tv.core.network.backendRetryDelayMillis
import com.playtorrio.tv.core.network.isRetryableBackendResponse
import com.playtorrio.tv.core.network.isSafeBackendRetryRequest
import com.playtorrio.tv.data.local.ServerConfigurationStore
...
object SupabaseModule {
    ...
    fun provideSupabaseClient(
        ...
        val userAgent = "PlayTorrioTV/${BuildConfig.VERSION_NAME.ifBlank { "dev" }}"
