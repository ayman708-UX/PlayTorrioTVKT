...
import com.playtorrio.tv.data.remote.supabase.SupabaseWatchProgress
import com.playtorrio.tv.data.remote.supabase.SupabaseWatchProgressEvent
...
class WatchProgressSyncService @Inject constructor(
     ...
     * Always syncs regardless of CW source — both Trakt and PlayTorrio Sync
