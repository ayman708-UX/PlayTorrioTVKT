...
import com.playtorrio.tv.core.debrid.DebridProviders
import com.playtorrio.tv.core.debrid.DebridStreamFormatterDefaults
import com.playtorrio.tv.core.profile.ProfileManager
import com.playtorrio.tv.domain.model.DebridSettings
import com.playtorrio.tv.domain.model.DebridStreamCodecFilter
import com.playtorrio.tv.domain.model.DebridStreamEncode
import com.playtorrio.tv.domain.model.DebridStreamFeatureFilter
import com.playtorrio.tv.domain.model.DebridStreamMinimumQuality
import com.playtorrio.tv.domain.model.DebridStreamPreferences
import com.playtorrio.tv.domain.model.DebridStreamResolution
import com.playtorrio.tv.domain.model.DebridStreamSortCriterion
import com.playtorrio.tv.domain.model.DebridStreamSortDirection
import com.playtorrio.tv.domain.model.DebridStreamSortKey
import com.playtorrio.tv.domain.model.DebridStreamSortMode
import com.playtorrio.tv.domain.model.DebridStreamVisualTag
import com.playtorrio.tv.domain.model.normalizeDebridInstantPlaybackPreparationLimit
import com.playtorrio.tv.domain.model.normalizeDebridStreamMaxResults
...
class DebridSettingsDataStore @Inject constructor(
    ...
    private fun DebridStreamPreferences.normalized(): DebridStreamPreferences {
        ...
        val preferredQualitiesValue: List<com.playtorrio.tv.domain.model.DebridStreamQuality>? = preferredQualities
        val requiredQualitiesValue: List<com.playtorrio.tv.domain.model.DebridStreamQuality>? = requiredQualities
        val excludedQualitiesValue: List<com.playtorrio.tv.domain.model.DebridStreamQuality>? = excludedQualities
        ...
        val preferredAudioTagsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioTag>? = preferredAudioTags
        val requiredAudioTagsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioTag>? = requiredAudioTags
        val excludedAudioTagsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioTag>? = excludedAudioTags
        val preferredAudioChannelsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioChannel>? = preferredAudioChannels
        val requiredAudioChannelsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioChannel>? = requiredAudioChannels
        val excludedAudioChannelsValue: List<com.playtorrio.tv.domain.model.DebridStreamAudioChannel>? = excludedAudioChannels
        ...
        val preferredLanguagesValue: List<com.playtorrio.tv.domain.model.DebridStreamLanguage>? = preferredLanguages
        val requiredLanguagesValue: List<com.playtorrio.tv.domain.model.DebridStreamLanguage>? = requiredLanguages
        val excludedLanguagesValue: List<com.playtorrio.tv.domain.model.DebridStreamLanguage>? = excludedLanguages
        ...
        return copy(
            ...
            preferredQualities = preferredQualitiesValue?.ifEmpty { com.playtorrio.tv.domain.model.DebridStreamQuality.defaultOrder } ?: com.playtorrio.tv.domain.model.DebridStreamQuality.defaultOrder,
            ...
            preferredAudioTags = preferredAudioTagsValue?.ifEmpty { com.playtorrio.tv.domain.model.DebridStreamAudioTag.defaultOrder } ?: com.playtorrio.tv.domain.model.DebridStreamAudioTag.defaultOrder,
            requiredAudioTags = requiredAudioTagsValue.orEmpty(),
            excludedAudioTags = excludedAudioTagsValue.orEmpty(),
            preferredAudioChannels = preferredAudioChannelsValue?.ifEmpty { com.playtorrio.tv.domain.model.DebridStreamAudioChannel.defaultOrder } ?: com.playtorrio.tv.domain.model.DebridStreamAudioChannel.defaultOrder,
