...
internal fun PersistedTrackPreference.toTrackPreference(): com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.TrackPreference? {
    val audio = if (audioLanguage != null || audioName != null || audioTrackId != null) {
        com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
    ...
    val subtitle = when (subtitleType) {
        "INTERNAL" -> com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Internal(
            track = com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
        ...
        "ADDON" -> com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Addon(
            id = addonSubtitleId ?: "",
            url = addonSubtitleUrl ?: "",
            language = subtitleLanguage ?: "",
            addonName = addonSubtitleAddonName ?: ""
        )
        "DISABLED" -> com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Disabled
        else -> null
    }

    if (audio == null && subtitle == null) return null
    return com.playtorrio.tv.ui.screens.player.PlayerRuntimeController.TrackPreference(
        audio = audio,
        subtitle = subtitle
    )
}
