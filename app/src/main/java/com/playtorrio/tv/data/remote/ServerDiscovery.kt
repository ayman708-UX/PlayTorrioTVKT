package com.playtorrio.tv.data.remote

import com.playtorrio.tv.BuildConfig
import com.playtorrio.tv.domain.model.ServerCapabilities
...
internal object ServerDiscoveryPolicy {
    ...
    fun discoveryUrl(input: String): String {
        ...
        val suffix = "/.well-known/playtorrio"
    ...
    fun parse(discoveryUrl: String, document: String): ServerConfiguration {
        ...
        if (!payload.service.equals("playtorrio", ignoreCase = true)) {
