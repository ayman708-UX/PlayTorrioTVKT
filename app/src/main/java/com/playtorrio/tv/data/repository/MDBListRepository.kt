...
import com.playtorrio.tv.data.remote.dto.mdblist.MDBListRatingRequestDto
import com.playtorrio.tv.domain.model.MDBListRatings
import com.playtorrio.tv.domain.model.MDBListRatingsResult
        ...
        val imdbId = resolveImdbId(
            meta = Meta(
                ...
                type = when (normalizeMediaType(itemType)) {
                    "show" -> com.playtorrio.tv.domain.model.ContentType.SERIES
                    else -> com.playtorrio.tv.domain.model.ContentType.MOVIE
                },
                name = itemId,
                poster = null,
