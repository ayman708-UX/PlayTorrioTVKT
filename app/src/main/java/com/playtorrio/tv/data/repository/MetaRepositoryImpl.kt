...
class MetaRepositoryImpl @Inject constructor(
    ...
    override fun getMeta(
        ...
        // The caller names the addon but not necessarily a type it serves. PlayTorrio's
    ...
    private fun inferCanonicalType(type: String, id: String): String {
        ...
        // "tv" is PlayTorrio's internal synonym for episodic content. Stremio metadata
    ...
    private fun buildMissingMetaFailure(addon: Addon): MetaAttemptFailure {
        return MetaAttemptFailure(
            ...
            detail = context.getString(com.playtorrio.tv.R.string.meta_error_detail_no_metadata_for_id)
        )
    }
