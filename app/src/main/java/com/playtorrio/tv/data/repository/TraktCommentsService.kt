...
class TraktCommentsService @Inject constructor(
    ...
    suspend fun getCommentsPage(
        ...
        targetEpisode: com.playtorrio.tv.domain.model.Video? = null,
        page: Int = 1,
        ...
        } ?: throw IllegalStateException(appContext.getString(com.playtorrio.tv.R.string.trakt_comments_error_request_failed))
    ...
    private suspend fun resolveCommentsTarget(
        ...
        targetEpisode: com.playtorrio.tv.domain.model.Video?
...
private fun toReviewModel(dto: TraktCommentDto, appContext: android.content.Context): TraktCommentReview {
    val authorDisplayName = dto.user?.name
        ...
        ?: dto.user?.username
            ?.takeIf { it.isNotBlank() }
        ?: appContext.getString(com.playtorrio.tv.R.string.trakt_user_fallback)
