...
data class DebridSettings(
    ...
    val resolverServices: List<com.playtorrio.tv.core.debrid.DebridServiceCredential>
        get() = DebridProviders.configuredResolverServices(this)

    val activeResolverCredential: com.playtorrio.tv.core.debrid.DebridServiceCredential?
    ...
    val hasCloudLibraryProvider: Boolean
        get() = DebridProviders.configuredServices(this)
            .any { credential -> credential.provider.supports(com.playtorrio.tv.core.debrid.DebridProviderCapability.CloudLibrary) }
