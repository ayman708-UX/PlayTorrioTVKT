...
fun SourceStatusFilterChip(
    ...
    val textColor = when {
        isError -> PlayTorrioTheme.colors.Error
        isFocused || isSelected -> PlayTorrioTheme.colors.OnSecondary
    ...
    FilterChip(
        ...
        colors = FilterChipDefaults.colors(
            containerColor = if (shouldUseNormalColors) PlayTorrioTheme.colors.BackgroundCard else PlayTorrioTheme.colors.Error.copy(alpha = 0.05f),
            focusedContainerColor = if (shouldUseNormalColors) PlayTorrioTheme.colors.Secondary else PlayTorrioTheme.colors.Error.copy(alpha = 0.08f),
            selectedContainerColor = if (shouldUseNormalColors) PlayTorrioTheme.colors.Secondary else PlayTorrioTheme.colors.Error.copy(alpha = 0.07f),
            focusedSelectedContainerColor = if (shouldUseNormalColors) PlayTorrioTheme.colors.Secondary else PlayTorrioTheme.colors.Error.copy(alpha = 0.09f),
        ...
        border = FilterChipDefaults.border(
            border = Border(
                border = BorderStroke(PlayTorrioTheme.spacing.hairline, if (isError) PlayTorrioTheme.colors.Error.copy(alpha = 0.7f) else PlayTorrioTheme.colors.Border),
                shape = RoundedCornerShape(20.dp)
            ),
            focusedBorder = Border(
                border = if (isError) {
                    BorderStroke(PlayTorrioTheme.spacing.xxs, PlayTorrioTheme.colors.Error.copy(alpha = 0.8f))
                } else {
            ...
            selectedBorder = Border(
                border = BorderStroke(PlayTorrioTheme.spacing.hairline, if (isError) PlayTorrioTheme.colors.Error.copy(alpha = 0.75f) else PlayTorrioTheme.colors.Primary),
                shape = RoundedCornerShape(20.dp)
            ),
        ...
        Row(
            ...
            if (isLoading) {
                LoadingIndicator(
                    ...
                    color = if (isFocused || isSelected) PlayTorrioTheme.colors.OnSecondary else PlayTorrioTheme.colors.TextSecondary
                )
            }
            Text(
                text = name,
