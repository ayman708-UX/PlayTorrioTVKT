...
fun AccountScreen(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(vertical = PlayTorrioTheme.spacing.xxl),
...
private fun LinkedDevicesSection(
    devices: List<com.playtorrio.tv.data.remote.supabase.SupabaseLinkedDevice>,
            ...
            devices.forEach { device ->
                Row(
                    ...
                    Button(
                        ...
                        shape = ButtonDefaults.shape(RoundedCornerShape(PlayTorrioTheme.radii.sm))
                    ) {
                        Icon(
