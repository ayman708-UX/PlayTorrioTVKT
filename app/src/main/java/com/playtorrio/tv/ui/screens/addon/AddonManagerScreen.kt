...
fun AddonManagerScreen(
    ...
    val manageFromPhoneSubtitle = if (webConfigMode == com.playtorrio.tv.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
    ...
    val qrInstruction = if (webConfigMode == com.playtorrio.tv.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
                ...
                item {
                    Card(
                        ...
                        Text(
                            ...
                            modifier = androidx.compose.ui.Modifier.padding(PlayTorrioTheme.spacing.lg)
                        )
                    }
                }
            }
            ...
            item {
                Row(
                    ...
                    if (uiState.isLoading && uiState.installedAddons.isEmpty()) {
                        LoadingIndicator(modifier = Modifier.height(PlayTorrioTheme.spacing.xl))
                    }
                }
            }
