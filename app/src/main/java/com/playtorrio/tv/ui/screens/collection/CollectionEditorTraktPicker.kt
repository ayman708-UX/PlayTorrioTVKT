...
import com.playtorrio.tv.core.trakt.TraktPublicListSearchResult
...
private fun TraktSectionTitle(title: String) {
    Text(title, style = MaterialTheme.typography.labelLarge, color = PlayTorrioTheme.colors.TextSecondary)
}
