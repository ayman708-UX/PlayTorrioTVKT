...
import com.playtorrio.tv.data.local.ValidationResult
    ...
    Column(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.sm)) {
                            ...
                            try {
                                ...
                                withContext(Dispatchers.IO) {
                                    ...
                                    resolver.delete(
                                        ...
                                        arrayOf("playtorrio-collections.json")
                                    )
                                    // Write new file
                                    val values = android.content.ContentValues().apply {
                                        put(android.provider.MediaStore.Downloads.DISPLAY_NAME, "playtorrio-collections.json")
                ...
                PlayTorrioButton(onClick = { viewModel.showImportDialog() }) {
        ...
        if (uiState.collections.isEmpty()) {
            ...
            LazyColumn(
                modifier = Modifier.fillMaxSize(),
                contentPadding = PaddingValues(bottom = PlayTorrioTheme.spacing.xxxl),
...
private fun ImportContent(
    ...
    Column(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.sm)) {
                PlayTorrioButton(onClick = onBack) { Text(stringResource(R.string.collections_cancel)) }
            }
        }
        ...
        LazyColumn(
                    ...
                    ImportMode.entries.filter { it != ImportMode.PASTE }.forEach { mode ->
                        ...
                        if (mode == importMode) {
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    containerColor = PlayTorrioTheme.colors.Primary,
                                    contentColor = PlayTorrioTheme.colors.Background,
                                    focusedContainerColor = PlayTorrioTheme.colors.Primary,
                                    focusedContentColor = PlayTorrioTheme.colors.Background
                                ),
                                border = ButtonDefaults.border(
                                    focusedBorder = Border(
                                        border = PlayTorrioTheme.focusRing.border(PlayTorrioTheme.spacing.xxs),
                            ...
                            PlayTorrioButton(onClick = { onModeChange(mode) }) {
                                Text(label)
                            }
                        }
                    }
            ...
            item {
                when (importMode) {
                    ImportMode.PASTE -> {
                        Row(horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.sm)) {
                            PlayTorrioButton(onClick = onPaste) { Text(stringResource(R.string.collections_paste_clipboard)) }
                            if (importText.isNotBlank()) {
                                PlayTorrioButton(onClick = onValidate) { Text(stringResource(R.string.collections_validate)) }
                            }
                        }
                        ...
                        Surface(
                            shape = RoundedCornerShape(PlayTorrioTheme.radii.md),
                            colors = SurfaceDefaults.colors(containerColor = PlayTorrioTheme.colors.BackgroundElevated),
                            border = Border(
                                border = BorderStroke(PlayTorrioTheme.spacing.hairline, if (importError != null) PlayTorrioTheme.colors.Error else PlayTorrioTheme.colors.Border),
                                shape = RoundedCornerShape(PlayTorrioTheme.radii.md)
                            ),
                            modifier = Modifier
                                .fillMaxWidth()
                    ...
                    ImportMode.FILE -> {
                        ...
                        PlayTorrioButton(onClick = onPickFile) { Text(stringResource(R.string.collections_load_file)) }
                    ...
                    ImportMode.URL -> {
                        Surface(
                            ...
                            Box(modifier = Modifier.padding(horizontal = PlayTorrioTheme.spacing.md), contentAlignment = Alignment.CenterStart) {
                                BasicTextField(
                                    value = importUrl,
                        ...
                        PlayTorrioButton(onClick = onFetchUrl) {
            ...
            if (validationResult != null && validationResult.valid) {
                item {
                    ...
                    Surface(
                        ...
                        border = Border(
                            border = BorderStroke(PlayTorrioTheme.spacing.hairline, PlayTorrioTheme.colors.Primary),
                            shape = RoundedCornerShape(PlayTorrioTheme.radii.md)
                        ),
                        modifier = Modifier.fillMaxWidth()
                    ) {
                        Column(modifier = Modifier.padding(PlayTorrioTheme.spacing.lg)) {
                            Text(
                            ...
                            Spacer(modifier = Modifier.height(PlayTorrioTheme.spacing.md))
                            PlayTorrioButton(onClick = onConfirmImport) {
...
private fun CollectionListItem(
    ...
    Surface(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.xs)) {
                Button(
                    onClick = onMoveUp,
                    enabled = !isFirst,
                    colors = ButtonDefaults.colors(
