...
import com.playtorrio.tv.ui.util.dpadRepeatThrottle
import com.playtorrio.tv.ui.util.dpadVerticalFastScroll
...
import com.playtorrio.tv.ui.components.CatalogRowSection
import com.playtorrio.tv.ui.components.ContentCard
...
import com.playtorrio.tv.ui.components.PosterCardStyle
import com.playtorrio.tv.ui.components.LocalCardDepthStyle
import com.playtorrio.tv.ui.components.playtorrioCardDepth
import com.playtorrio.tv.domain.model.CardDepthSurface
import com.playtorrio.tv.ui.screens.home.ClassicHomeContent
import com.playtorrio.tv.ui.screens.home.ContinueWatchingItem
import com.playtorrio.tv.ui.screens.home.GridHomeContent
import com.playtorrio.tv.ui.screens.home.HeroBackdropState
import com.playtorrio.tv.ui.screens.home.HomeScreenFocusState
import com.playtorrio.tv.ui.screens.home.key
import com.playtorrio.tv.domain.model.MetaPreview
import com.playtorrio.tv.ui.screens.home.ModernHomeContent
...
fun FolderDetailScreen(
    ...
    if (folder == null) {
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            Text(stringResource(R.string.folder_detail_not_found), color = PlayTorrioTheme.colors.TextSecondary)
        }
        return
    }

    val isItemWatched: (MetaPreview) -> Boolean = remember(uiState.movieWatchedStatus) {
        { item -> uiState.movieWatchedStatus[com.playtorrio.tv.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
...
@Composable
private fun FolderHeader(folder: com.playtorrio.tv.domain.model.CollectionFolder) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(horizontal = PlayTorrioTheme.spacing.xxxl, vertical = PlayTorrioTheme.spacing.sm),
        ...
        if (!folder.coverImageUrl.isNullOrBlank()) {
            ...
            when (folder.tileShape) {
                com.playtorrio.tv.domain.model.PosterShape.POSTER -> { iconWidth = PlayTorrioTheme.spacing.xxl; iconHeight = PlayTorrioTheme.spacing.xxxl }
                com.playtorrio.tv.domain.model.PosterShape.LANDSCAPE -> { iconWidth = 64.dp; iconHeight = 36.dp }
                com.playtorrio.tv.domain.model.PosterShape.SQUARE -> { iconWidth = PlayTorrioTheme.spacing.xxxl; iconHeight = PlayTorrioTheme.spacing.xxxl }
            }
            AsyncImage(
...
private fun TabbedGridContent(
    ...
    folder: com.playtorrio.tv.domain.model.CollectionFolder,
    ...
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(start = PlayTorrioTheme.spacing.xxxl, end = PlayTorrioTheme.spacing.xxxl, top = PlayTorrioTheme.spacing.sm, bottom = PlayTorrioTheme.spacing.sm),
        verticalAlignment = Alignment.CenterVertically,
        ...
        currentTab.catalogRow != null -> {
            ...
            LazyVerticalGrid(
                ...
                contentPadding = PaddingValues(
                    ...
                    top = PlayTorrioTheme.spacing.lg,
                    bottom = PlayTorrioTheme.spacing.xxxl
                ),
                horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.lg),
                    ...
                    item(
                        ...
                        Column(
                            ...
                            Spacer(
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .padding(top = PlayTorrioTheme.spacing.sm)
                                    .height(
...
private fun RowsContent(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(top = PlayTorrioTheme.spacing.lg, bottom = PlayTorrioTheme.spacing.xxxl),
        verticalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.xxl)
    ) {
                    ...
                    tab.isLoading -> {
                        Column(modifier = Modifier.fillMaxWidth()) {
                            Text(
                                ...
                                color = PlayTorrioTheme.colors.TextPrimary,
                                modifier = Modifier.padding(start = PlayTorrioTheme.spacing.xxxl, end = PlayTorrioTheme.spacing.xxxl, bottom = PlayTorrioTheme.spacing.md)
                            )
                            Box(
                                modifier = Modifier
                                    .fillMaxWidth()
                    ...
                    tab.error != null -> {
                        Column(modifier = Modifier.fillMaxWidth()) {
                            ...
                            Box(
                                ...
                                Text(text = tab.error, color = PlayTorrioTheme.colors.TextSecondary)
                            }
                        }
                    }
                    catalogRow != null -> {
...
private fun FollowLayoutContent(
    ...
    val isItemWatched: (MetaPreview) -> Boolean = remember(homeState.movieWatchedStatus) {
        { item -> homeState.movieWatchedStatus[com.playtorrio.tv.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
    val loadMoreLabel = stringResource(R.string.action_load_more)
