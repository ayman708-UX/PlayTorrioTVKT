...
fun CollectionSection(
    ...
    title: String? = null,
    posterCardCornerRadius: Dp = PlayTorrioTheme.spacing.md,
    ...
    val landscapeStyle = remember(posterCardCornerRadius) {
        PosterCardStyle(
            ...
            focusedBorderWidth = PlayTorrioTheme.spacing.xxs,
            focusedScale = 1.02f
        )
    }
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = if (title.isNullOrBlank()) PlayTorrioTheme.spacing.sm else 20.dp, bottom = PlayTorrioTheme.spacing.sm)
    ) {
        if (!title.isNullOrBlank()) {
            Text(
                ...
                modifier = Modifier
                    .padding(start = PlayTorrioTheme.spacing.xxxl, end = PlayTorrioTheme.spacing.xxxl, bottom = PlayTorrioTheme.spacing.sm)
            )
        }
        LazyRow(
            modifier = Modifier
                    ...
                    if (!year.isNullOrBlank()) {
                        Text(
                            ...
                            modifier = Modifier
                                ...
                                .padding(start = PlayTorrioTheme.spacing.xxs, end = PlayTorrioTheme.spacing.xxs, top = PlayTorrioTheme.spacing.xxs)
                        )
                    }
                }
            }
