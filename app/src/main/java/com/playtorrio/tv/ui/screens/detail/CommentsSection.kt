...
fun CommentsSection(
    ...
    val cardShape = RoundedCornerShape(PlayTorrioTheme.radii.xl)
        ...
        Row(
            ...
            Image(
                ...
                modifier = Modifier
                    ...
                    .width(47.dp)
                    .height(20.dp),
                colorFilter = ColorFilter.tint(PlayTorrioTheme.colors.TextPrimary)
            )
            Text(
...
private fun CommentModeButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.colors(
            containerColor = if (selected) PlayTorrioTheme.colors.Secondary else PlayTorrioTheme.colors.BackgroundCard,
            contentColor = if (selected) PlayTorrioTheme.colors.OnSecondary else PlayTorrioTheme.colors.TextPrimary
        )
    ) {
        Text(text)
    }
        ...
        Column(
            ...
            Text(
                ...
                color = if (review.hasSpoilerContent) {
                    PlayTorrioTheme.colors.Warning
                } else {
...
private fun CommentChip(text: String) {
    ...
    Box(
        modifier = Modifier
            .background(
                color = PlayTorrioTheme.colors.BackgroundElevated,
                shape = shape
            )
        ...
        Column(
            ...
            if (seasons.isNotEmpty()) {
                LazyRow(
                    ...
                    contentPadding = PaddingValues(horizontal = PlayTorrioTheme.spacing.md, vertical = PlayTorrioTheme.spacing.xs),
                    horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.sm)
                ) {
                        ...
                        Button(
                            ...
                            colors = ButtonDefaults.colors(
                                ...
                                contentColor = if (seasonNumber == season) {
                                    PlayTorrioTheme.colors.OnSecondary
                                } else {
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.colors(
                            containerColor = if (episode.id == selectedEpisodeId) {
                                PlayTorrioTheme.colors.FocusBackground
                            } else {
                                PlayTorrioTheme.colors.BackgroundCard
                            },
                            contentColor = PlayTorrioTheme.colors.TextPrimary
    ...
    Dialog(
        ...
        Box(
            modifier = Modifier
                ...
                .padding(horizontal = PlayTorrioTheme.spacing.xl, vertical = 10.dp)
        ) {
            AnimatedContent(
                targetState = review,
                transitionSpec = {
            ...
            Column(
                modifier = Modifier
                    ...
                    .width(168.dp)
                    .padding(top = 6.dp, end = PlayTorrioTheme.spacing.xs)
                    .focusRequester(primaryFocusRequester)
                    .focusable()
                    .focusProperties {
    ...
    Row(
        ...
        labels.forEachIndexed { index, label ->
            if (index > 0) {
                Box(
                    modifier = Modifier
                        .size(PlayTorrioTheme.spacing.xs)
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .width(160.dp)
                .height(18.dp)
                .background(PlayTorrioTheme.colors.BackgroundElevated, shape = shape)
        )
        Row(horizontalArrangement = Arrangement.spacedBy(PlayTorrioTheme.spacing.sm)) {
            repeat(3) {
                Box(
