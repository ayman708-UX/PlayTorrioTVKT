...
fun EpisodeRatingsSection(
    ...
    val defaultChipColor = PlayTorrioTheme.colors.BackgroundCard
    val defaultChipTextColor = PlayTorrioTheme.colors.TextSecondary
    ...
    Column(
        modifier = modifier
            .fillMaxWidth()
            .padding(top = if (hasTitle) 14.dp else 6.dp, bottom = PlayTorrioTheme.spacing.sm)
    ) {
        if (hasTitle) {
            Text(
                text = title,
        ...
        when {
            isLoading -> {
                Text(
                    ...
                    modifier = Modifier.padding(horizontal = PlayTorrioTheme.spacing.xxxl, vertical = PlayTorrioTheme.spacing.md)
                )
            }
            error != null -> {
                Text(
            ...
            seasonNumbers.isEmpty() -> {
                ...
                Text(
                    ...
                    modifier = Modifier.padding(horizontal = PlayTorrioTheme.spacing.xxxl, vertical = PlayTorrioTheme.spacing.xxs)
                )
