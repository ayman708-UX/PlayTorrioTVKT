...
fun MoreLikeThisSection(
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = PlayTorrioTheme.spacing.sm, bottom = PlayTorrioTheme.spacing.sm)
    ) {
        LazyRow(
            modifier = Modifier
                .fillMaxWidth()
            ...
            ?.let { label ->
                Text(
                    ...
                    modifier = Modifier
                        ...
                        .padding(end = 10.dp, top = PlayTorrioTheme.spacing.xxs, bottom = PlayTorrioTheme.spacing.xxs)
                )
            }
    }
}
