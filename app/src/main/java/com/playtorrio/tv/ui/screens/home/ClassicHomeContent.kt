...
import com.playtorrio.tv.ui.components.CollectionRowSection
import com.playtorrio.tv.ui.components.ContinueWatchingSection
import com.playtorrio.tv.domain.model.ContinueWatchingCardStyle
import com.playtorrio.tv.ui.components.HeroCarousel
import com.playtorrio.tv.ui.components.HeroCarouselBackdrop
...
fun ClassicHomeContent(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(top = if (heroVisible) PlayTorrioTheme.spacing.none else PlayTorrioTheme.spacing.xl, bottom = PlayTorrioTheme.spacing.xl),
