...
import com.playtorrio.tv.LocalContentFocusRequester
...
import com.playtorrio.tv.domain.model.catalogRowStableKey
...
import com.playtorrio.tv.ui.components.GridContinueWatchingSection
import com.playtorrio.tv.domain.model.ContinueWatchingCardStyle
import com.playtorrio.tv.ui.components.HeroCarousel
import com.playtorrio.tv.ui.components.PosterCardDefaults
import com.playtorrio.tv.ui.components.PosterCardStyle
import com.playtorrio.tv.ui.components.collectionFolderCardImageUrl
...
fun GridHomeContent(
    ...
    onItemFocus: (com.playtorrio.tv.domain.model.MetaPreview) -> Unit = {},
    ...
    val topPadding = if (hasHero) PlayTorrioTheme.spacing.none else PlayTorrioTheme.spacing.xl
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        val horizontalPadding = PlayTorrioTheme.spacing.xxxl + PlayTorrioTheme.spacing.xl
        val spacing = PlayTorrioTheme.spacing.md
        ...
        LazyVerticalGrid(
            ...
            contentPadding = PaddingValues(
                ...
                end = PlayTorrioTheme.spacing.xl,
                top = topPadding,
                bottom = PlayTorrioTheme.spacing.xxl
            ),
...
private fun SectionDivider(
    ...
    Box(
        modifier = modifier
            .fillMaxWidth()
            .padding(top = PlayTorrioTheme.spacing.xl, bottom = PlayTorrioTheme.spacing.md)
    ) {
        Text(
            text = catalogName,
...
private fun StickyCategoryHeader(
    ...
    Box(
        modifier = modifier
            ...
            .padding(horizontal = PlayTorrioTheme.spacing.xxxl, vertical = PlayTorrioTheme.spacing.md)
    ) {
        Text(
            text = sectionName,
        ...
        Card(
            ...
            border = CardDefaults.border(
                focusedBorder = Border(
                    border = PlayTorrioTheme.focusRing.border(posterCardStyle.focusedBorderWidth),
                    shape = seeAllCardShape
                )
            ),
