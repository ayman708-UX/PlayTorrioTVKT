...
import com.playtorrio.tv.domain.model.WatchedItem
...
private data class CatalogUpdateResult(
    ...
    val heroItems: List<com.playtorrio.tv.domain.model.MetaPreview>,
                        ...
                        if (currentLayout == HomeLayout.MODERN) {
                            ...
                            val fakeItems = (0 until 8).map { i ->
                                MetaPreview(
                                    ...
                                    type = com.playtorrio.tv.domain.model.ContentType.fromString(placeholder.apiType),
...
internal fun HomeViewModel.mergeRefreshedCatalogRow(
    ...
    val identity = { item: com.playtorrio.tv.domain.model.MetaPreview -> item.apiType + ":" + item.id }
