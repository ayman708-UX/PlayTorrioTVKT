package com.playtorrio.tv.ui.screens.library
...
import com.playtorrio.tv.core.cloud.CloudLibraryFile
import com.playtorrio.tv.core.cloud.CloudLibraryItem
import com.playtorrio.tv.core.cloud.CloudLibraryItemType
import com.playtorrio.tv.core.cloud.CloudLibraryPlaybackInfo
...
import com.playtorrio.tv.ui.components.EmptyScreenState
import com.playtorrio.tv.ui.components.GridContentCard
...
import com.playtorrio.tv.ui.screens.stream.PlayerChoiceDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import com.playtorrio.tv.ui.components.PosterCardDefaults
...
import com.playtorrio.tv.ui.util.formatAddonTypeLabel
import com.playtorrio.tv.ui.util.localizedContentType
...
fun LibraryScreen(
    ...
    LazyVerticalGrid(
        ...
        contentPadding = PaddingValues(start = PlayTorrioTheme.spacing.xxxl, end = PlayTorrioTheme.spacing.xxxl, top = PlayTorrioTheme.spacing.xl, bottom = PlayTorrioTheme.spacing.xxl),
        ...
        item(span = { GridItemSpan(maxLineSpan) }) {
            Row(
                ...
                Text(
                    ...
                    color = if (showBuiltInHeader) PlayTorrioTheme.colors.TextPrimary else Color.Transparent,
                ...
                Text(
                    text = when {
                        ...
                        uiState.isPlayTorrioAccount -> "PLAYTORRIO"
                        else -> stringResource(R.string.library_source_local)
                    },
                    style = MaterialTheme.typography.labelLarge,
                    color = if (showBuiltInHeader) PlayTorrioTheme.colors.TextTertiary else Color.Transparent,
        ...
        item(span = { GridItemSpan(maxLineSpan) }) { Spacer(modifier = Modifier.height(PlayTorrioTheme.spacing.sm)) }
    }
        ...
        Box(
            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .background(PlayTorrioTheme.colors.BackgroundElevated, RoundedCornerShape(10.dp))
        ...
        Surface(
            ...
            BasicTextField(
                ...
                cursorBrush = SolidColor(
                    if (editing) PlayTorrioTheme.colors.FocusRing else Color.Transparent
                ),
...
private fun CloudLibraryCard(
    ...
    Card(
        ...
        border = CardDefaults.border(
            border = Border(border = BorderStroke(PlayTorrioTheme.spacing.hairline, PlayTorrioTheme.colors.Border), shape = RoundedCornerShape(10.dp)),
            focusedBorder = Border(border = PlayTorrioTheme.focusRing.border(PlayTorrioTheme.spacing.xxs), shape = RoundedCornerShape(10.dp))
        ),
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    color = if (item.playableFiles.isEmpty()) PlayTorrioTheme.colors.TextTertiary else PlayTorrioTheme.colors.Primary
                )
            }
        }
    }
...
private fun LibraryDropdownPicker(
    ...
    Box(modifier = modifier) {
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (isFocused) PlayTorrioTheme.colors.FocusRing else PlayTorrioTheme.colors.TextSecondary
                    )
                }
            }
        }
        ...
        DropdownMenu(
            ...
            shape = RoundedCornerShape(14.dp),
            containerColor = PlayTorrioTheme.colors.BackgroundCard,
            tonalElevation = PlayTorrioTheme.spacing.none,
            shadowElevation = PlayTorrioTheme.spacing.sm,
            border = BorderStroke(PlayTorrioTheme.spacing.hairline, PlayTorrioTheme.colors.Border)
        ) {
            options.forEach { option ->
                ...
                val itemTextColor = when {
                    isOptionFocused -> PlayTorrioTheme.colors.OnSecondary
                    isSelected -> PlayTorrioTheme.colors.TextPrimary
                    else -> PlayTorrioTheme.colors.TextPrimary
                }
                val itemBackgroundColor = when {
                    isOptionFocused -> PlayTorrioTheme.colors.Secondary
                    isSelected -> PlayTorrioTheme.colors.FocusBackground
                ...
                DropdownMenuItem(
                    modifier = Modifier
                        ...
                        .padding(horizontal = 6.dp, vertical = PlayTorrioTheme.spacing.xxs)
                        .background(
                    ...
                    colors = MenuDefaults.itemColors(
                        ...
                        disabledTextColor = PlayTorrioTheme.colors.TextDisabled
                    )
                )
            }
        }
...
private fun ManageListsDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Box(
            modifier = Modifier
                .width(620.dp)
                .background(PlayTorrioTheme.colors.BackgroundElevated, RoundedCornerShape(PlayTorrioTheme.radii.xl))
                .padding(PlayTorrioTheme.spacing.xl)
        ) {
            Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
                ...
                if (personalTabs.isEmpty()) {
                    Text(
                        ...
                        style = MaterialTheme.typography.bodyMedium,
                        color = PlayTorrioTheme.extendedColors.textSecondary
                    )
                } else {
                    LazyColumn(
                        modifier = Modifier
    ...
    PlayTorrioDialog(
        ...
        androidx.compose.material3.OutlinedTextField(
            ...
            colors = androidx.compose.material3.OutlinedTextFieldDefaults.colors(
                focusedTextColor = PlayTorrioTheme.colors.TextPrimary,
                unfocusedTextColor = PlayTorrioTheme.colors.TextPrimary,
                focusedContainerColor = PlayTorrioTheme.colors.BackgroundCard,
                unfocusedContainerColor = PlayTorrioTheme.colors.BackgroundCard,
                focusedBorderColor = PlayTorrioTheme.colors.FocusRing,
                unfocusedBorderColor = PlayTorrioTheme.colors.Border,
                focusedLabelColor = PlayTorrioTheme.colors.TextSecondary,
                unfocusedLabelColor = PlayTorrioTheme.colors.TextTertiary,
                cursorColor = PlayTorrioTheme.colors.FocusRing
            )
        )
