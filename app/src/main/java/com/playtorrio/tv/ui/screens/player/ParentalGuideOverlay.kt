...
private val ROW_GAP = PlayTorrioTheme.spacing.xxs
...
fun ParentalGuideOverlay(
    ...
    Row(
        modifier = modifier
            ...
            .padding(start = PlayTorrioTheme.spacing.xxl, top = PlayTorrioTheme.spacing.xl),
        ...
        Box(
            modifier = Modifier
                ...
                .clip(RoundedCornerShape(PlayTorrioTheme.spacing.hairline))
