...
import com.playtorrio.tv.core.player.dvmkv.MatroskaExtractor as DvMatroskaExtractor
    ...
    return ExtractorsFactory {
        ...
        extractors.forEachIndexed { index, extractor ->
            ...
            if (extractor is StockMatroskaExtractor) {
                extractors[index] = PlayTorrioAssMatroskaExtractor(subtitleParserFactory, assHandler)
            }
            ...
            if (extractor is DvMatroskaExtractor) {
                extractors[index] = PlayTorrioAssMatroskaExtractor(
