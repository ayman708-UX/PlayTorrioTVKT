...
internal data class PlayerNavigationArgs(
    ...
    companion object {
        fun from(savedStateHandle: SavedStateHandle): PlayerNavigationArgs {
            ...
            val rawVideoId = savedStateHandle.get<String>("videoId")?.takeIf { it.isNotEmpty() }
            val (extractedSeason, extractedEpisode) = com.playtorrio.tv.core.debrid.DebridMediaMatcher.extractSeasonAndEpisode(rawVideoId)
            ...
            return PlayerNavigationArgs(
                ...
                videoId = rawVideoId,
                initialSeason = savedStateHandle.get<String>("season")?.toIntOrNull() ?: extractedSeason,
                initialEpisode = savedStateHandle.get<String>("episode")?.toIntOrNull() ?: extractedEpisode,
