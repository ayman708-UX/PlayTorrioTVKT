...
import com.playtorrio.tv.core.tracking.TRACKING_SCROBBLE_DIAGNOSTIC_TAG
...
import com.playtorrio.tv.core.tracking.scrobbleDiagnosticIdentity
...
import com.playtorrio.tv.data.repository.PlaybackIssuePlaybackSettingsInput
import com.playtorrio.tv.data.repository.PlaybackIssueReportInput
 ...
 * guard in [com.playtorrio.tv.core.player.ExternalPlaybackTracker].
 */
            ...
            _exoPlayer?.let { player ->
                ...
                if (player.isPlaying) {
                    ...
                    if (now - lastBufferLogTimeMs >= 10_000) {
                        ...
                        if (PlayTorrioExoPlayerPerformanceHelper.shouldLogMemoryFootprint()) {
...
private fun PlayerRuntimeController.buildPlaybackIssuePlaybackSettingsInput(): PlaybackIssuePlaybackSettingsInput {
    ...
    return PlaybackIssuePlaybackSettingsInput(
        ...
        playtorrioPerformanceModeEnabled = settings.playtorrioPerformanceModeEnabled,
        ...
        PlayerEvent.OnRetry -> {
            ...
            if (isTorrentStream && currentInfoHash != null) {
                ...
                launchTorrentSourceStream(
                    stream = com.playtorrio.tv.domain.model.Stream(
...
internal fun PlayerRuntimeController.buildStreamInfoData(): StreamInfoData {
    ...
    return StreamInfoData(
        ...
        playerEngine = when (currentInternalPlayerEngine) {
            com.playtorrio.tv.data.local.InternalPlayerEngine.EXOPLAYER -> context.getString(R.string.playback_engine_exoplayer)
            com.playtorrio.tv.data.local.InternalPlayerEngine.MVP_PLAYER -> context.getString(R.string.playback_engine_mvplayer)
            com.playtorrio.tv.data.local.InternalPlayerEngine.AUTO -> null
        }
    )
}
