    ...
    PlayTorrioDialog(
        ...
        Card(
            ...
            border = CardDefaults.border(
                border = Border(
                    border = androidx.compose.foundation.BorderStroke(PlayTorrioTheme.spacing.hairline, PlayTorrioTheme.colors.Border),
            ...
            Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = PlayTorrioTheme.spacing.md)) {
                BasicTextField(
                    ...
                    cursorBrush = SolidColor(
                        if (isInputFocused) PlayTorrioTheme.colors.Primary
