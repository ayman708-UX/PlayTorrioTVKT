        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (selected.isEmpty()) PlayTorrioTheme.colors.FocusBackground else PlayTorrioTheme.colors.BackgroundCard,
                ...
                Row(
                    ...
                    Text(
                        text = allLabel,
                        color = if (selected.isEmpty()) PlayTorrioTheme.colors.Primary else PlayTorrioTheme.colors.TextPrimary,
            ...
            if (items.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    contentPadding = androidx.compose.foundation.layout.PaddingValues(vertical = PlayTorrioTheme.spacing.xs)
                ) {
                    items(
                        items = items,
                        key = { it }
                ...
                LazyRow(
                    ...
                    itemsIndexed(
                        ...
                        Card(
                            ...
                            Text(
                                text = label,
                                modifier = Modifier.padding(horizontal = 14.dp, vertical = PlayTorrioTheme.spacing.sm),
                ...
                Card(
                    ...
                    Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = PlayTorrioTheme.spacing.md)) {
                        BasicTextField(
                            ...
                            cursorBrush = SolidColor(if (isInputFocused) PlayTorrioTheme.colors.Primary else Color.Transparent),
