...
import com.playtorrio.tv.data.local.SubtitleLanguageOption
...
internal fun LazyListScope.subtitleSettingsItems(
    ...
    item(key = "subtitle_advanced_header") {
        Spacer(modifier = androidx.compose.ui.Modifier.height(PlayTorrioTheme.spacing.lg))
        Text(
            text = stringResource(R.string.sub_advanced_section),
            style = MaterialTheme.typography.titleMedium,
            color = PlayTorrioTheme.colors.TextSecondary,
            modifier = androidx.compose.ui.Modifier.padding(vertical = PlayTorrioTheme.spacing.sm)
        )
    }
