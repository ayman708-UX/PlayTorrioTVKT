...
import com.playtorrio.tv.domain.model.AppIconOption
...
import com.playtorrio.tv.ui.theme.getFontFamily
...
fun ThemeSettingsContent(
    ...
    val appliedSettingsUiStyle = PlayTorrioTheme.settingsUiStyle
    LaunchedEffect(Unit) {
            ...
            SettingsGroupCard(
                ...
                Row(
                    modifier = Modifier
                        ...
                        .padding(horizontal = PlayTorrioTheme.spacing.xs, vertical = PlayTorrioTheme.spacing.xs)
...
private fun ThemeSwatchChip(
    ...
    Card(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = PlayTorrioTheme.spacing.sm, vertical = PlayTorrioTheme.spacing.md),
