...
@Immutable
class PlayTorrioFocusRingStyle internal constructor(
...
internal fun createFocusRingStyle(palette: ThemeColorPalette): PlayTorrioFocusRingStyle {
    return PlayTorrioFocusRingStyle(
