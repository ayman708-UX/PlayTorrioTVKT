...
@Immutable
data class PlayTorrioLayoutTokens(
...
@Immutable
data class PlayTorrioMediaTokens(
...
object PlayTorrioLayout {
    val tokens = PlayTorrioLayoutTokens(
...
object PlayTorrioMedia {
    val tokens = PlayTorrioMediaTokens(
