...
@Immutable
data class PlayTorrioMotionDurations(
    val instant: Int,
    val quick: Int,
    val fast: Int,
    val medium: Int,
...
@Immutable
data class PlayTorrioMotionEasings(
    val standard: Easing,
...
@Immutable
data class PlayTorrioMotionTokens(
    val durations: PlayTorrioMotionDurations,
    val easings: PlayTorrioMotionEasings,
...
@Immutable
data class PlayTorrioFocusTokens(
    val scale: Float,
...
object PlayTorrioMotion {
    val tokens = PlayTorrioMotionTokens(
        durations = PlayTorrioMotionDurations(
            instant = 0,
            quick = 125,
            fast = 180,
            medium = 350,
        ...
        easings = PlayTorrioMotionEasings(
...
object PlayTorrioFocus {
    val tokens = PlayTorrioFocusTokens(
        scale = 1.02f,
        subtleScale = 1.01f,
        pressedScale = 0.98f,
        disabledScale = 1f,
