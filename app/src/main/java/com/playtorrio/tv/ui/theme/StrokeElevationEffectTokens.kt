...
@Immutable
data class PlayTorrioStrokeTokens(
    val none: Dp,
    val hairline: Dp,
    val thin: Dp,
    val medium: Dp,
...
@Immutable
data class PlayTorrioElevationTokens(
    val none: Dp,
    val card: Dp,
    val focused: Dp,
    val menu: Dp,
...
@Immutable
data class PlayTorrioEffectTokens(
    val blurSoft: Dp,
    val blurPanel: Dp,
    val blurStrong: Dp,
...
object PlayTorrioStrokes {
    val tokens = PlayTorrioStrokeTokens(
        none = 0.dp,
        hairline = 1.dp,
        thin = 1.5.dp,
        medium = 2.dp,
...
object PlayTorrioElevations {
    val tokens = PlayTorrioElevationTokens(
        none = 0.dp,
        card = 2.dp,
        focused = 8.dp,
        menu = 8.dp,
...
object PlayTorrioEffects {
    val tokens = PlayTorrioEffectTokens(
        blurSoft = 12.dp,
        blurPanel = 26.dp,
        blurStrong = 40.dp,
