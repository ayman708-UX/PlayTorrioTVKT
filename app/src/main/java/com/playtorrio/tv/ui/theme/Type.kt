...
@Immutable
data class PlayTorrioTextStyleTokens(
...
fun buildPlayTorrioTypography(fontFamily: FontFamily): Typography = Typography(
...
@OptIn(ExperimentalTvMaterial3Api::class)
val PlayTorrioTypography = buildPlayTorrioTypography(InterFamily)

@OptIn(ExperimentalTvMaterial3Api::class)
fun buildPlayTorrioTextStyles(typography: Typography): PlayTorrioTextStyleTokens = PlayTorrioTextStyleTokens(
...
@OptIn(ExperimentalTvMaterial3Api::class)
val PlayTorrioTextStyles = buildPlayTorrioTextStyles(PlayTorrioTypography)
