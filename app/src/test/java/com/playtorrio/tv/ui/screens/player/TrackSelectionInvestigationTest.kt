...
class TrackSelectionInvestigationTest {
    ...
    fun testBuildStreamInfoDataWithActiveVideoFormat() {
        ...
        every { controller.currentInternalPlayerEngine } returns com.playtorrio.tv.data.local.InternalPlayerEngine.EXOPLAYER
    ...
    fun testDolbyVisionExtractorsFactoryFormatRewriting() {
        ...
        val factory = com.playtorrio.tv.core.player.DolbyVisionExtractorsFactory(
            delegate = delegateFactory,
            config = com.playtorrio.tv.core.player.DolbyVisionConversionConfig(active = false),
            stripDvRpu = true
        )
